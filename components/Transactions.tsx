      ...
      {loading ? (
        ...
        <>
          {transactions.length === 0 ? (
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-5xl h-[80vh] overflow-y-scroll scrollbar-thin scrollbar-thumb-teal-500 scrollbar-track-gray-100 hover:scrollbar-thumb-teal-600">
